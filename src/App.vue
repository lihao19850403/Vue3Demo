...
export default {
  ...
  components: {
	...
	// ch5_cmd_for,
	// ch5_cmd_custom,
	// ch5_cmd_downpull_menu,
	// ch6_computed,
	// ch7_watch,
	// ch8_event_decorations,
	// ch8_event_keys,
...
<template>
  <!-- <index_old></index_old> -->
  <!-- <ch2_welcome></ch2_welcome> -->
  <!-- <ch4_create></ch4_create> -->
  <!-- <ch4_methods></ch4_methods> -->
  <!-- <ch4_lifecycle></ch4_lifecycle> -->
  <!-- <ch4_cmd></ch4_cmd> -->
  <!-- <ch5_cmd_normal></ch5_cmd_normal> -->
  <!-- <ch5_cmd_for></ch5_cmd_for> -->
  <!-- <ch5_cmd_custom></ch5_cmd_custom> -->
  <!-- <ch5_cmd_downpull_menu></ch5_cmd_downpull_menu> -->
  <!-- <ch6_computed></ch6_computed> -->
  <!-- <ch7_watch></ch7_watch> -->
  <!-- <ch8_event_decorations></ch8_event_decorations> -->
  <!-- <ch8_event_keys></ch8_event_keys> -->
  <!-- <ch8_event_userinfo_handler></ch8_event_userinfo_handler> -->
  <!-- <ch9_class_style></ch9_class_style> -->
  <!-- <ch9_shop_list></ch9_shop_list> -->
  <!-- <ch10_user_register></ch10_user_register> -->
  <!-- <ch11_components></ch11_components> -->
  <!-- <ch11_communication></ch11_communication> -->
  <!-- <ch11_slot></ch11_slot> -->
  <!-- <ch11_new_apis></ch11_new_apis> -->
  <!-- <ch11_project_catagory></ch11_project_catagory> -->
